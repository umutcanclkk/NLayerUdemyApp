...
{
    public class CutomersUpdateDtoValidator : AbstractValidator<CustomersUpdateDto>
    {
        ...
        private bool BeValidNumeric(string phoneNumber)
        {
        ...
        public CutomersUpdateDtoValidator()
        {
            RuleFor(x => x.Id).NotEmpty();
            //RuleFor(x => x.Id).GreaterThan(0).WithMessage("{Customers ıd } must be greater than 0");
